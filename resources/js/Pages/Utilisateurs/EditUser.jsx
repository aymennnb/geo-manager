            ...
            {Width > 930 ? (
                ...
                <div className="w-full px-2 py-1">
                    <div className="bg-white shadow-sm rounded-md">
                        <div className="p-3">
                            <h3 className="text-sm font-medium mb-2">Modifier l'utilisateur</h3>
                            <form onSubmit={handleSubmit}>
                                {/* Nom Input */}
                                <div className="mb-2">
                                ...
                                <div className="flex space-x-2 mt-3">
                                    ...
                                    <button
                                        type="submit"
                                        disabled={processing}
                                        className={`flex-1 px-2 py-1 text-xs bg-yellow-100 text-yellow-600 rounded-md hover:text-yellow-900 transition ${
